...
Blockchain: A digital ledger that records all transactions or information in blocks. Each block is linked to the one before and after, creating a continuous chain of information—hence the name blockchain.
