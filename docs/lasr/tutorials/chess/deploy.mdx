...
<Steps>
### Clone the LASR Chess Repository
...
:::info
See the [CLI](/lasr_guides/cli) or [Deploy Configuration](/lasr_guides/deploy_configuration) for additional information about the deploy.
:::
