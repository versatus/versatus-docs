...
id: playing_chess
slug: /tutorials/chess/playing_chess
description: ''
tags: []
---
...
In the [last step](/tutorials/chess/deploy#deploy-lasr-chess) of the deployment, you were required to save the `program address` from the CLI output. Use this, along with credentials from your `keypairs.json` file, to link the frontend with your LASR Chess project:
