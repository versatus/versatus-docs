...
description: "Step-by-step guide to creating and deploying a project using the Non-fungible Template on the Versatus LASR network."
tags: ['Versatus', 'LASR', 'non-fungible tokens', 'NFTs', 'template', 'tutorial', 'blockchain']
---

import MediaWrapper from '../../../../src/components/Media/MediaWrapper';

This page guides you through the process of creating a new project using the [Non-fungible Template](/lasr/core_concepts/templates#non-fungible-template). The non-fungible template is tailored for projects that require non-fungible tokens (NFTs). Unlike fungible tokens, non-fungible tokens cannot be split up. Follow the step-by-step guide below to create and deploy your non-fungible project:
...
- `<PAYMENT_PROGRAM_ADDRESS>`: The address of the payment program.
