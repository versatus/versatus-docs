...
title: Using BURD
id: using_burd
slug: /tutorials/burd/using_burd
description: ''
tags: []
---
...
In the [last step](/tutorials/burd/deploy#deploy-burd) of the deployment, you were required to save the `program address` from the CLI output. Use this, along with credentials from your `keypairs.json` file, to link the frontend with your BURD project:
