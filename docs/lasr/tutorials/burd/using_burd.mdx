...
In the [last step](/lasr/tutorials/burd/deploy#deploy-burd) of the deployment, you were required to save the `program address` from the CLI output. Use this, along with credentials from your `keypairs.json` file, to link the frontend with your BURD project:
