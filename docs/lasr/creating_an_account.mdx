...
Access [LASR Wallet](https://chromewebstore.google.com/detail/lasr-wallet/oejckhoamfdjjiefkebeakcobjpedfeb) to check the necessary steps to add the wallet to your browser.
...
:::warning Wallet password X Secret Key
...
In addition to having an account, you need to have a Local Keypair to deploy your application. Access the [Creating Your First Program](/lasr/creating_your_first_program) page to learn how to create and deploy an application.
