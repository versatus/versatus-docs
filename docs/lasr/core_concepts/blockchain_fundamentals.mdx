...
<LinkCards numColumns={2} data={[
  {
    name: 'Transition to Web3 - Course 1 | Blockchain Basics',
    linkTo: 'https://www.risein.com/courses/blockchain-basics',
  },
  {
    name: 'Transition to Web3 - Course 2 | Transactions and Bitcoin',
  ...
  {
    name: 'Transition to Web3 - Course 4 | Web3 Fundamentals',
