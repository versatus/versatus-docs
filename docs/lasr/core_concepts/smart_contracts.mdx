...
id: smart_contracts
slug: /lasr/core_concepts/smart_contracts
description: "An overview of smart contracts, explaining their functionality, deployment, execution, and how Versatus LASR supports them in a programming language-agnostic way."
tags: ['Versatus', 'LASR', 'smart contracts', 'blockchain', 'Web3', 'virtual machines']
---
