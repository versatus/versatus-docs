...
:::info
  When testing your program, you can create JSON files to simulate a call from the LASR network and ensure your program is behaving as expected, as described in the page [Creating Your First Program](/lasr/getting_started/creating_your_first_program#test-your-program).
:::