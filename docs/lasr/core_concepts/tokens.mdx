...
Versatus LASR provides templates for you to create applications based on [fungible](/tutorials/fungible) or [non-fungible](/tutorials/non_fungible) tokens. These templates aim to help you to start creating new applications. In case you need additional guidance, you can check one of Versatus LASR tutorials:

- [BURD](/tutorials/burd): A microblog application similar to Twitter that uses NFTs to store user data. 
- [LASR Chess](/tutorials/chess): A Virtual Chess game built in LASR, leveraging the [chess.js](https://github.com/jhlywa/chess.js) library allowing users to play matches against each other.
