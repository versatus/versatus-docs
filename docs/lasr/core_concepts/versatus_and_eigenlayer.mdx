...
slug: /lasr/core_concepts/versatus_and_eigenlayer
description: "Overview of how Versatus LASR leverages EigenLayer and EigenDA for data availability and transaction verification, enhancing scalability and developer experience."
tags: ['Versatus', 'LASR', 'EigenLayer', 'EigenDA', 'stateless rollup', 'scalability', 'blockchain']
---

Versatus LASR was designed to operate without maintaining a continuous on-chain state. Instead, it relies on reconstructing transactions from data snapshots. These snapshots are efficiently managed and stored through EigenDA, a tool provided by [EigenLayer](https://www.eigenlayer.xyz/).

:::info
  Access the [Stateless Rollup](/lasr/core_concepts/stateless_rollup) for additional information on how it works.
:::
