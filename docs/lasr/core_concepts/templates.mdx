...
The Hello LASR template is a example project to help you deploy your first program in LASR. This template goal is to guide you through the essential parts of any program you may want to deploy on LASR. You can find this tutorial at our [Getting Started](/getting_started/creating_your_first_program) guides.
