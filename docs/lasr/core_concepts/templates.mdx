...
<Callout>
Find tutorials to learn how to use each template in the [LASR Tutorials](/tutorials/overview) section of the docs.
</Callout>
...
The faucet template is a specialized template for creating new tokens in the network. This template is particularly useful in test networks where tokens have no real-world value. By using a faucet, developers can obtain test tokens to facilitate testing and development without the need to acquire real tokens. Versatus recommends you to use the faucet template to:
